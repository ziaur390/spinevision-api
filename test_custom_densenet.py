...
model = CustomSpineClassifier(num_classes=len(data['classes']))

try:
    missing, unexpected = model.load_state_dict(data['model_state'], strict=True)
    print("Model loaded PERFECTLY with strict=True!")
