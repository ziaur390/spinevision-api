                            ...
                            <div className="bg-white rounded-2xl shadow-sm border border-gray-100">
                                <div className="p-6 border-b border-gray-100 bg-gradient-to-r from-indigo-50 to-purple-50 rounded-t-2xl">
                                    <div className="flex items-center gap-3">
                                        ...
                                        <div>
                                            <h3 className="text-xl font-bold text-gray-800">AI Clinical Recommendation</h3>
                                            <p className="text-gray-500 text-sm mt-1">Generated by Gemini AI based on analysis findings</p>
                                        </div>
                                    </div>
                                </div>
                                <div className="p-6">
